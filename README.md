<div align="center">
    ...
    <p>
        <a href="https://github.com/MarSeventh/CloudFlare-ImgBed/blob/main/README.md">简体中文</a> | <a href="https://github.com/MarSeventh/CloudFlare-ImgBed/blob/main/README_en.md">English</a> | <a href="https://cfbed.allovend.de">官方网站</a>
    </p>
    <p align="center">
...
免费文件托管解决方案，具有**上传**、**管理**、**读取**、**删除**等全链路功能，覆盖文件全生命周期，支持**鉴权**、**目录**、**图片审查**、**随机图**等各项特性（详见[功能文档](https://cfbed.allovend.de/guide/features.html)）。

![CloudFlare](static/readme/海报.png)

# 2. [Document](https://cfbed.allovend.de)

提供详细的部署文档、功能文档、开发计划、更新日志、常见问题解答等，帮助您快速上手。

[![更新日志](https://recent-update.cfbed.allovend.de/cn)](https://cfbed.allovend.de/guide/update-log.html)
...
- **前端开源**：参见[MarSeventh/allovend-cloudhub](https://github.com/MarSeventh/allovend-cloudhub)项目。

- **生态建设**：欢迎社区参与生态建设，欢迎提交 PR 或者 Issue，优质内容参见[官网生态建设页面](https://cfbed.allovend.de/about/ecosystem.html)。
...
- **Sponsors**：感谢以下赞助者对本项目的支持！
  ...
  [![赞助者](https://afdian-sponsors.allovend.de/image?columns=12)](https://afdian.com/a/marseventh)
